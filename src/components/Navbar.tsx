  ...
  return (
    <header className="bg-white shadow-md p-4">
      <div className="flex justify-between items-center">
        ...
        <nav
          className={`${isMenuOpen ? "flex flex-col absolute top-16 left-0 right-0 bg-white p-4 shadow-md" : "hidden"} lg:flex lg:items-center lg:space-x-4 lg:static lg:shadow-none lg:p-0`}
        >
